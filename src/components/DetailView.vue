<template >
    ...
    <section class="flex pt-16 mb-16 xlg:flex-row flex-col ">
        ...
        <div class="flex-1 relative">
            <span class=" absolute xlg:right-0 text-text-gray opacity-60 font-bold font-serif right-0 sm:right-auto text-[100px] sm:text-[200px] leading-[150px]">{{ storeState.Images[props.id].year }}</span>
            ...
            <a :href="storeState.Images[props.id].source" target="_blank" rel="noopener noreferrer" class="underline block mt-16 font-serif text-dark-gray hover:text-black transition-colors text-[10px] font-bold">GO TO SOURCE</a>
            </div>
        </div>
    </section>
